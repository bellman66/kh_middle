...
public class StellerController {
	...
	public Object avgAllPrice() throws Exception {
	...
	@RequestMapping(value = "aroundAll.do", method = { RequestMethod.GET,
			RequestMethod.POST }, produces = "text/plain;charset=UTF-8") // alert 한글꺠지는거 방지.
	@ResponseBody // POST 방식의 경우 response body를 통해 파라미터를 가져옴.
	public Object aroundAll(@RequestBody Map<String, Object> paramData) throws Exception {
