				...
				<div class="spotlight">
					<div class="content">
						...
						<form name="updateform" method="POST"
							action="${pageContext.request.contextPath}/customer/s_update.do">
							<div>글번호</div>
							<div>
								<input name="s_no" value="${data.s_no}" type="text"
									readonly="readonly" />
							</div>
							<div>작성자</div>
							<div>
								<input name="s_writer" value="${data.s_writer}" type="text"
									readonly="readonly" />
							</div>
							<div>게시글제목 :</div>
							<div>
								<input name="s_title" value="${data.s_title}" type="text" />
							</div>
							<div>게시글내용 :</div>
							<div>
								<textarea name="s_content" rows="5" cols="50">${data.s_content}</textarea>
							</div>
							<div>조회수</div>
							<div>
								<input name="s_viewCnt" value="${data.s_viewCnt}" type="text"
									readonly="readonly" />
							</div>
							<div>작성일자</div>
							<div>
								<fmt:formatDate value="${data.s_regDate}"
