   ...
   <div id="wrapper">
      ...
      <div id="main">
         ...
         <section id="intro" class="main">
            <div class="spotlight">
               ...
               <span class="image"><img
                  src="${pageContext.request.contextPath}/resources/steller/images/fuel.png"
                  alt=""></span>
            </div>
         </section>
         ...
         <!-- <section id="second" class="main special">
            ...
            <input type="text" class="kv-fa rating-loading" value="3.75"
               data-size="xl" title=""> <br> <input type="text"
               class="kv-fa rating-loading" value="2.5" data-size="lg" title="">
            <br> <input type="text" class="kv-fa rating-loading"
               value="1.75" data-size="md" title=""> <br> <input
               type="text" class="kv-fa rating-loading" value="4" data-size="sm"
               title=""> <br> <input type="text"
               class="kv-fa rating-loading" value="2" data-size="xs" title="">
            <br>
...
<!--       <footer id="footer">
   ...
   <script
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/steller/assets/js/map.js?20200520"></script>
</body>
</html>